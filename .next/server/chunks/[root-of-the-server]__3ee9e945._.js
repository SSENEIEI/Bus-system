...
async function POST(request) {
    try {
        ...
        const users = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("SELECT * FROM users WHERE username = ?", [
            username
        ]);
        if (users.length === 0) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "ไม่พบผู้ใช้"
        }, {
            status: 404
        });
        ...
        let department_ids = [];
        try {
            const rows = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT department_id FROM user_departments WHERE user_id = ?', [
                user.id
            ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3ee9e945._.js.map