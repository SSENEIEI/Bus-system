module.exports = [
"[project]/.next-internal/server/app/api/transport/masters/pickup-points/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/transport/masters/pickup-points/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    let where = '';
    if (routeId) {
        where = 'WHERE (route_id IS NULL OR route_id = ?)';
        params.push(routeId);
    }
    const rows = await withInitRetry(()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT id, name, route_id FROM pickup_points ${where} ORDER BY name`, params));
...
async function POST(request) {
    ...
    await withInitRetry(()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('INSERT INTO pickup_points (name, route_id) VALUES (?,?)', [
            name.trim(),
            route_id || null
        ]));
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function PUT(request) {
    ...
    if (!id || !name || !name.trim()) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: 'missing fields'
    }, {
        status: 400
    });
    await withInitRetry(()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('UPDATE pickup_points SET name=?, route_id=? WHERE id=?', [
            name.trim(),
            route_id || null,
            id
        ]));
...
async function DELETE(request) {
    ...
    await withInitRetry(()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('DELETE FROM pickup_points WHERE id=?', [
            id
        ]));
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ok: true
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c53aacde._.js.map