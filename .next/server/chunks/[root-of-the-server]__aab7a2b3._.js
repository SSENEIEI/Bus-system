module.exports = [
"[project]/.next-internal/server/app/api/route-pdfs/list/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/route-pdfs/list/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const isProd = process.env.VERCEL === '1' || ("TURBOPACK compile-time value", "development") === 'production';
        const map = {};
        let lastUpdated = null;
        if (isProd) {
            // List blobs from Vercel Blob storage
            try {
                const resp = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$vercel$2f$blob$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["list"])({
                    prefix: 'route-pdfs/'
                });
            ...
            const dir = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'public', 'route-pdfs');
            try {
                ...
                for (const f of files){
                    ...
                    try {
                        const st = await __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["promises"].stat(__TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(dir, f));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__aab7a2b3._.js.map