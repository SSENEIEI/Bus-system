module.exports = [
"[project]/.next-internal/server/app/api/ot/departments/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/ot/departments/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const sql = plantId ? `SELECT d.id, d.plant_id, p.code as plant_code, d.code, d.name
         FROM departments d JOIN plants p ON p.id = d.plant_id
         WHERE d.plant_id = ?
         ORDER BY d.plant_id ASC, d.created_at ASC, d.id ASC` : `SELECT d.id, d.plant_id, p.code as plant_code, d.code, d.name
         FROM departments d JOIN plants p ON p.id = d.plant_id
         ORDER BY d.plant_id ASC, d.created_at ASC, d.id ASC`;
        const rows = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(sql, plantId ? [
            plantId
        ] : []);
            ...
            try {
             ...
             ORDER BY d.plant_id ASC, d.created_at ASC, d.id ASC`;
                ...
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    error: e2.message || 'Internal error'
                }, {
                    status: 500
                });
            }
...
async function POST(request) {
    ...
    try {
        ...
        if (!plant_id || !code && !name) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'missing plant_id and name/code'
        }, {
            status: 400
        });
        const finalCode = code && code.trim() ? code.trim() : name && name.trim() ? name.trim().toUpperCase() : null;
        if (!finalCode) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'code cannot be null'
        }, {
            status: 400
        });
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('INSERT INTO departments (plant_id, code, name) VALUES (?,?,?)', [
            plant_id,
            finalCode,
            name || null
        ]);
    ...
    try {
        ...
        if (code !== undefined || name !== undefined) {
            ...
            if (code !== undefined && code !== null && String(code).trim() !== '') {
                ...
                updates.push('code = ?');
                params.push(String(name).trim().toUpperCase());
            } else {
        ...
        params.push(id);
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`UPDATE departments SET ${updates.join(', ')} WHERE id = ?`, params);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: true
        });
    } catch (e) {
...
async function DELETE(request) {
    ...
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('DELETE FROM departments WHERE id = ?', [
            id
        ]);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: true
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6fd1bfac._.js.map