...
async function GET(req) {
    try {
        ...
        const rows = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("SELECT id, username, department, plant_id, department_id, is_admin, is_super_admin, created_at FROM users ORDER BY id ASC");
        let ud = [];
        try {
            ud = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT user_id, department_id FROM user_departments');
        } catch  {
            ud = [];
        }
        const map = new Map();
        ...
        const withDeptIds = rows.map((u)=>({
                ...u,
                department_ids: map.get(u.id) || (u.department_id ? [
                    u.department_id
                ] : [])
            }));
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(withDeptIds);
    } catch (err) {
        if (err.message === 'NO_TOKEN') return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'ไม่พบ token'
        }, {
            status: 401
        });
        if (err.message === 'NOT_ADMIN') return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function POST(req) {
    try {
        ...
        if (!username || !password) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'ต้องมี username/password'
        }, {
            status: 400
        });
        const hashed = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].hash(password.trim(), 10);
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO users (username, password, display_name, plant_id, department_id, is_admin, is_super_admin)
       VALUES (?,?,?,?,?,?,?)`, [
            username.trim(),
            hashed,
            display_name,
        ...
        // sync department_ids
        try {
            const u = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT id FROM users WHERE username = ?', [
                username.trim()
            ]);
            const userId = u[0]?.id;
            if (userId && Array.isArray(department_ids)) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('DELETE FROM user_departments WHERE user_id = ?', [
                    userId
                ]);
                for (const did of department_ids){
                    if (did != null) await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('INSERT IGNORE INTO user_departments (user_id, department_id) VALUES (?,?)', [
                        userId,
                        did
                    ]);
                }
            ...
            console.error('POST user_departments sync failed:', e.message);
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        if (err.code === 'ER_DUP_ENTRY') return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'ชื่อนี้ถูกใช้แล้ว'
        }, {
            status: 400
        });
...
async function PUT(req) {
    try {
        ...
        if (!updates.length) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'ไม่มีข้อมูลที่จะอัปเดต'
        }, {
            status: 400
        });
        params.push(id);
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`UPDATE users SET ${updates.join(', ')} WHERE id = ?`, params);
        ...
        if (Array.isArray(department_ids)) {
            try {
                ...
                console.error('PUT user_departments sync failed:', e.message);
            }
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function DELETE(req) {
    try {
        ...
        const rows = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT username FROM users WHERE id = ?', [
            id
        ]);
        ...
        if (rows[0].username === 'adminscrap' || rows[0].username === 'adminga') {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'ห้ามลบ adminscrap'
            }, {
                status: 400
            });
        }
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('DELETE FROM users WHERE id = ?', [
            id
        ]);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__06295fd3._.js.map