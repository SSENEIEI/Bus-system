...
"[project]/src/app/api/bookings/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        if (token) {
            try {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].verify(token, SECRET_KEY);
            } catch (e) {
        ...
        const bookings = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT 
        b.id,
        b.truck_number,
        b.department,
        b.percentage,
...
async function POST(request) {
    try {
        ...
        const { productId, truckNumber, department, percentage, bookingDate } = await request.json();
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO bookings (user_id, product_id, truck_number, department, percentage, booking_date)
       VALUES (?, ?, ?, ?, ?, ?)`, [
            decoded.userId,
            productId,
            truckNumber,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fc888579._.js.map