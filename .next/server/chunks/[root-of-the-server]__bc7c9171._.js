module.exports = [
"[project]/.next-internal/server/app/api/ot/depart-times/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/ot/depart-times/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    const rows = await withInitRetry(()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(shiftId ? onlyActive ? 'SELECT id, shift_id, time, is_active, is_entry FROM depart_times WHERE shift_id = ? AND is_active <> 0 ORDER BY is_entry DESC, time' : 'SELECT id, shift_id, time, is_active, is_entry FROM depart_times WHERE shift_id = ? ORDER BY is_entry DESC, time' : onlyActive ? 'SELECT id, shift_id, time, is_active, is_entry FROM depart_times WHERE is_active <> 0 ORDER BY shift_id, is_entry DESC, time' : 'SELECT id, shift_id, time, is_active, is_entry FROM depart_times ORDER BY shift_id, is_entry DESC, time', shiftId ? [
            shiftId
        ] : []));
...
async function POST(request) {
    ...
    const existing = await withInitRetry(()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT id FROM depart_times WHERE shift_id = ? AND time = ? AND is_entry = ?', [
            shift_id,
            normTime,
            is_entry ? 1 : 0
        ]));
    if (existing.length) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: is_entry ? 'มีเวลาเข้าเวลานี้อยู่แล้วในกะนี้' : 'มีเวลาออกเวลานี้อยู่แล้วในกะนี้'
        }, {
            status: 409
        });
    }
    await withInitRetry(()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('INSERT INTO depart_times (shift_id, time, is_entry, is_active) VALUES (?,?,?,1)', [
            shift_id,
            normTime,
            is_entry ? 1 : 0
        ]));
...
async function DELETE(request) {
    ...
    await withInitRetry(()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('DELETE FROM depart_times WHERE id = ?', [
            id
        ]));
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ok: true,
...
async function PATCH(request) {
    ...
    if (!id || typeof is_active === 'undefined') return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: 'missing id or is_active'
    }, {
        status: 400
    });
    if (is_active) {
        await withInitRetry(()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('UPDATE depart_times SET is_active = 1, deactivated_at = NULL WHERE id = ?', [
                id
            ]));
    } else {
        await withInitRetry(()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('UPDATE depart_times SET is_active = 0, deactivated_at = NOW() WHERE id = ?', [
                id
            ]));
    }
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function PUT(request) {
    ...
    if (!id || !time) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: 'missing id or time'
    }, {
        status: 400
    });
    try {
        ...
        if (!targetShiftId) {
            const rows = await withInitRetry(()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT shift_id, is_entry FROM depart_times WHERE id = ?', [
                    id
                ]));
            ...
            if (typeof is_entry === 'undefined') {
                ...
                await withInitRetry(()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SET @keep_is_entry := ?', [
                        rows[0].is_entry
                    ]));
            }
        }
        ...
        const entryFlag = typeof is_entry === 'undefined' ? (await withInitRetry(()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT is_entry FROM depart_times WHERE id=?', [
                id
            ])))[0]?.is_entry : is_entry ? 1 : 0;
        const dup = await withInitRetry(()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT id FROM depart_times WHERE shift_id = ? AND time = ? AND is_entry = ? AND id <> ?', [
                targetShiftId,
                normTime,
                entryFlag,
                id
            ]));
        if (dup.length) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'มีเวลาออกนี้อยู่แล้วในกะนี้'
        }, {
            status: 409
        });
        await withInitRetry(()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('UPDATE depart_times SET shift_id = ?, time = ?, is_entry = ? WHERE id = ?', [
                targetShiftId,
                normTime,
                entryFlag,
                id
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: isDup ? 'เวลา (เข้า/ออก) ซ้ำในกะนี้' : 'อัปเดตเวลาออกล้มเหลว'
        }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bc7c9171._.js.map