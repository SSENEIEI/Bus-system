...
"[project]/src/app/api/locations/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const rows = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("SELECT id, name FROM locations ORDER BY name");
        ...
        if (err.code === 'ER_NO_SUCH_TABLE') {
            try {
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`CREATE TABLE IF NOT EXISTS locations (\n         id INT PRIMARY KEY AUTO_INCREMENT,\n         name VARCHAR(100) NOT NULL UNIQUE,\n         created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP\n       ) CHARSET=utf8mb4`);
                // Optional seed
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO locations (name) VALUES ('AC'),('RF'),('EMR'),('treasuryOUT') ON DUPLICATE KEY UPDATE name=VALUES(name)`);
                const rows2 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("SELECT id, name FROM locations ORDER BY name");
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(rows2);
            } catch (inner) {
...
async function POST(req) {
    try {
        ...
        if (!decoded.isAdmin) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "สิทธิ์ไม่เพียงพอ"
        }, {
            status: 403
        });
        const { name } = await req.json();
        if (!name || !name.trim()) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "name ต้องไม่ว่าง"
        }, {
            status: 400
        });
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("INSERT INTO locations (name) VALUES (?)", [
                name.trim()
            ]);
        } catch (err) {
            if (err.code === 'ER_NO_SUCH_TABLE') {
...
async function DELETE(req) {
    try {
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("DELETE FROM locations WHERE id = ?", [
                id
            ]);
        } catch (err) {
            if (err.code === 'ER_NO_SUCH_TABLE') {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["initDatabase"])();
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    error: "ตาราง locations ยังไม่ถูกสร้าง"
                }, {
                    status: 500
                });
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1a25f04e._.js.map