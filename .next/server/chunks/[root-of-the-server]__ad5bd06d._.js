module.exports = [
"[project]/.next-internal/server/app/api/ot/time-hides/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/ot/time-hides/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(rows.map((r)=>r.depart_time_id));
}
async function POST(request) {
    ...
    if (depart_time_ids.length) {
        const values = depart_time_ids.map((id)=>[
                the_date,
                shift_id,
                id,
                user.id || null
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ok: true,
        count: depart_time_ids.length
    });
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__ad5bd06d._.js.map