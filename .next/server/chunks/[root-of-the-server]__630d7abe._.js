module.exports = [
"[project]/.next-internal/server/app/api/transport/registrations/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/transport/registrations/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function withInitRetry(action) {
    try {
        ...
        if (!isNoTable && !isUnknownColumn) throw err;
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["initDatabase"])();
        return action();
    }
}
...
async function GET(request) {
    ...
    const rows = await withInitRetry(()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT tr.*, p.code AS plant_code, d.code AS dept_code, r.name AS route_name,
            COALESCE(tr.department_text, d.code, d.name, '') AS dept_display
    ...
    if (format === 'csv') {
        ...
        for (const r of rows){
            const dept = r.department_text || r.dept_code || '';
            const line = [
                r.employee_code,
                r.full_name,
                r.employee_type || '',
        ...
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"](csv, {
            headers: {
                ...
                'Content-Disposition': 'attachment; filename="transport-registrations.csv"'
            }
        });
    }
...
async function POST(request) {
    ...
    const { employee_code, full_name, employee_type = null, plant_id = null, department_id = null, department_text = null, route_id = null, pickup_point = null } = body || {};
    if (!employee_code || !full_name) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: 'missing fields'
    }, {
        status: 400
    });
    await withInitRetry(()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO transport_registrations (employee_code, full_name, employee_type, plant_id, department_id, department_text, route_id, pickup_point)
     VALUES (?,?,?,?,?,?,?,?)`, [
            employee_code,
            full_name,
            employee_type,
...
async function PUT(request) {
    ...
    const body = await request.json();
    const { id, employee_code, full_name, employee_type = null, plant_id = null, department_id = null, department_text = null, route_id = null, pickup_point = null } = body || {};
    ...
    await withInitRetry(()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`UPDATE transport_registrations SET employee_code=?, full_name=?, employee_type=?, plant_id=?, department_id=?, department_text=?, route_id=?, pickup_point=? WHERE id=?`, [
            employee_code,
            full_name,
            employee_type,
            plant_id,
...
async function DELETE(request) {
    ...
    await withInitRetry(()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('DELETE FROM transport_registrations WHERE id = ?', [
            id
        ]));
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ok: true
...
//# sourceMappingURL=%5Broot-of-the-server%5D__630d7abe._.js.map