module.exports = [
"[project]/.next-internal/server/app/api/ot/shifts/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/ot/shifts/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
async function GET() {
    const rows = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT id, name_th, name_en, is_active FROM shifts ORDER BY id');
...
async function POST(request) {
    ...
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('INSERT INTO shifts (name_th, name_en, is_active) VALUES (?,?,?)', [
        name_th,
        name_en || null,
        is_active ? 1 : 0
    ]);
...
async function DELETE(request) {
    ...
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('DELETE FROM shifts WHERE id = ?', [
        id
    ]);
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ok: true
...
//# sourceMappingURL=%5Broot-of-the-server%5D__983a4600._.js.map