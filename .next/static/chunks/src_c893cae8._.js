...
function OtOverview() {
    ...
    const loadOverviewCounts = async ()=>{
        try {
            const token = localStorage.getItem('token');
            const res = await fetch("/api/ot/overview-counts?date=".concat(date), {
                headers: token ? {
                    Authorization: "Bearer ".concat(token)
                } : {}
            });
    ...
    const fetchShopPlan = async ()=>{
        try {
            const token = localStorage.getItem('token');
            const res = await fetch("/api/ot/shops?date=".concat(date), {
                headers: {
                    Authorization: "Bearer ".concat(token)
                }
            });
    ...
    const fetchNursePlan = async ()=>{
        try {
            const token = localStorage.getItem('token');
            const res = await fetch("/api/ot/nurses?date=".concat(date), {
                headers: {
                    Authorization: "Bearer ".concat(token)
                }
            });
    ...
    const loadDeptLocks = async ()=>{
        try {
            const token = localStorage.getItem('token');
            const res = await fetch("/api/ot/locks?date=".concat(date, "&list=departments"), {
                headers: token ? {
                    Authorization: "Bearer ".concat(token)
                } : {}
            });
...
//# sourceMappingURL=src_c893cae8._.js.map